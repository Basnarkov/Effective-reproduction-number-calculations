...
The theoretical values are obtained by numerical simulation of the models (SIR and SIIS) to find the sizes of the compartments as a function of time, and numerical calculation of the integrals needed for the effectgive reproduction number.
